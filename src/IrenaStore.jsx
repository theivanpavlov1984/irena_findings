      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "clamp(28px,5vw,72px)", alignItems: "start" }} className="pv">
        ...
        <div style={{ paddingTop: 6 }}>
          ...
          <div style={{ marginTop: 36 }}>
            ...
            {tab === "desc" && (<div style={{ marginTop: 22, maxWidth: 460 }}>{String(lot.desc).split("\n\n").map((para, pi) => (<p key={pi} style={{ fontFamily: body, fontWeight: 300, fontSize: 16, lineHeight: 1.7, color: C.ink, marginTop: pi ? 16 : 0 }}>{para}</p>))}</div>)}
